...
Bridge.assembly("Bridge.Collections", function ($asm, globals) {
  ...
  Bridge.define("System.Collections.BitArray", {
    ...
    $ctor4: function (length, defaultValue) {
      ...
      this.m_array = System.Array.init(
        System.Collections.BitArray.getArrayLength(
          length,
    ...
    $ctor1: function (bytes) {
      ...
      this.m_array = System.Array.init(
        System.Collections.BitArray.getArrayLength(
          bytes.length,
          System.Collections.BitArray.BytesPerInt32
        ),
        0
      );
      this.m_length =
        (bytes.length * System.Collections.BitArray.BitsPerByte) | 0;

      var i = 0;
      var j = 0;
      while (((bytes.length - j) | 0) >= 4) {
        this.m_array[Bridge.identity(i, (i = (i + 1) | 0))] =
          (bytes[j] & 255) |
          ((bytes[(j + 1) | 0] & 255) << 8) |
          ((bytes[(j + 2) | 0] & 255) << 16) |
          ((bytes[(j + 3) | 0] & 255) << 24);
    ...
    ctor: function (values) {
      ...
      for (var i = 0; i < values.length; i = (i + 1) | 0) {
        if (values[i]) {
          this.m_array[Bridge.Int.div(i, 32) | 0] =
            this.m_array[Bridge.Int.div(i, 32) | 0] | (1 << i % 32);
        }
      }
    ...
    $ctor5: function (values) {
      ...
      this.m_length =
        (values.length * System.Collections.BitArray.BitsPerInt32) | 0;
    ...
    $ctor2: function (bits) {
      ...
      var arrayLength = System.Collections.BitArray.getArrayLength(
        bits.m_length,
        System.Collections.BitArray.BitsPerInt32
      );
    ...
    setLength: function (value) {
      ...
      var newints = System.Collections.BitArray.getArrayLength(
        value,
        System.Collections.BitArray.BitsPerInt32
      );
      if (
        newints > this.m_array.length ||
        ((newints + System.Collections.BitArray._ShrinkThreshold) | 0) <
          this.m_array.length
      ) {
        ...
        System.Array.copy(
          ...
          newarray,
          0,
          newints > this.m_array.length ? this.m_array.length : newints
        );
    ...
    get: function (index) {
      ...
      return (
        (this.m_array[Bridge.Int.div(index, 32) | 0] & (1 << index % 32)) !== 0
      );
    },
    set: function (index, value) {
      ...
      if (value) {
        this.m_array[Bridge.Int.div(index, 32) | 0] =
          this.m_array[Bridge.Int.div(index, 32) | 0] | (1 << index % 32);
      } else {
        this.m_array[Bridge.Int.div(index, 32) | 0] =
          this.m_array[Bridge.Int.div(index, 32) | 0] & ~(1 << index % 32);
      }
    ...
    setAll: function (value) {
      ...
      var ints = System.Collections.BitArray.getArrayLength(
        this.m_length,
        System.Collections.BitArray.BitsPerInt32
      );
  ...
  Bridge.define("System.Collections.Generic.BitHelper", {
    statics: {
      ...
      toIntArrayLength: function (n) {
        return n > 0
          ? ((Bridge.Int.div(
              (n - 1) | 0,
              System.Collections.Generic.BitHelper.IntSize
            ) |
              0) +
              1) |
              0
    ...
    markBit: function (bitPosition) {
      ...
      if (bitArrayIndex < this._length && bitArrayIndex >= 0) {
        var flag =
          System.Collections.Generic.BitHelper.MarkedBitFlag <<
          bitPosition % System.Collections.Generic.BitHelper.IntSize;
  ...
  Bridge.define("Bridge.Collections.EnumerableHelpers", {
    statics: {
      ...
      toArray: function (T, source) {
        var count = {};
        var results = {
          v: Bridge.Collections.EnumerableHelpers.toArray$1(T, source, count),
        };
      ...
      toArray$1: function (T, source, length) {
        ...
        try {
          if (en.System$Collections$IEnumerator$moveNext()) {
            ...
            var arr = {
              v: System.Array.init(DefaultCapacity, function () {
            ...
            while (en.System$Collections$IEnumerator$moveNext()) {
              ...
              arr.v[Bridge.identity(count, (count = (count + 1) | 0))] = en[
                Bridge.geti(
                  en,
                  "System$Collections$Generic$IEnumerator$1$" +
                    Bridge.getTypeAlias(T) +
  ...
  Bridge.define("System.Collections.Generic.HashSet$1", function (T) {
    return {
      inherits: [
      ...
      statics: {
        ...
        hashSetEquals: function (set1, set2, comparer) {
          ...
          if (
            System.Collections.Generic.HashSet$1(T).areEqualityComparersEqual(
              set1,
              set2
            )
          ) {
      ...
      ctor: function () {
        System.Collections.Generic.HashSet$1(T).$ctor3.call(
          this,
      ...
      $ctor1: function (collection) {
        System.Collections.Generic.HashSet$1(T).$ctor2.call(
          this,
          collection,
          System.Collections.Generic.EqualityComparer$1(T).def
        );
      ...
      $ctor2: function (collection, comparer) {
        ...
        if (
          (this._count === 0 &&
            this._slots.length >
              System.Collections.HashHelpers.getMinPrime()) ||
          (this._count > 0 &&
            (Bridge.Int.div(this._slots.length, this._count) | 0) >
              System.Collections.Generic.HashSet$1(T).ShrinkThreshold)
        ) {
          this.trimExcess();
        }
      },
      ...
      clear: function () {
        if (this._lastIndex > 0) {
          for (var i = 0; i < this._lastIndex; i = (i + 1) | 0) {
            this._slots[i] = new (System.Collections.Generic.HashSet$1.Slot(
              T
            ))();
          }
      ...
      contains: function (item) {
        if (this._buckets != null) {
          ...
          for (
            var i = (this._buckets[hashCode % this._buckets.length] - 1) | 0;
            i >= 0;
            i = this._slots[i].next
          ) {
            if (
              this._slots[i].hashCode === hashCode &&
              this._comparer[
                "System$Collections$Generic$IEqualityComparer$1$" +
                  Bridge.getTypeAlias(T) +
                  "$equals2"
              ](this._slots[i].value, item)
            ) {
              return true;
            }
          }
      ...
      copyTo$2: function (array, arrayIndex, count) {
        ...
        for (
          var i = 0;
          i < this._lastIndex && numCopied < count;
          i = (i + 1) | 0
        ) {
      ...
      remove: function (item) {
        if (this._buckets != null) {
          ...
          var last = -1;
          for (
            var i = (this._buckets[bucket] - 1) | 0;
            i >= 0;
            last = i, i = this._slots[i].next
          ) {
            if (
              this._slots[i].hashCode === hashCode &&
              this._comparer[
      ...
      getEnumerator: function () {
        return new (System.Collections.Generic.HashSet$1.Enumerator(T).$ctor1)(
          this
        );
      },
      ...
      intersectWith: function (other) {
        ...
        var otherAsCollection = Bridge.as(
          other,
          System.Collections.Generic.ICollection$1(T)
        );
      ...
      setEquals: function (other) {
        ...
        if (
          ...
          if (otherAsCollection != null) {
            if (
              this._count === 0 &&
              System.Array.getCount(otherAsCollection, T) > 0
            ) {
              return false;
            }
          }
          var result = this.checkUniqueAndUnfoundElements(other, true).$clone();
          return (
            result.uniqueCount === this._count && result.unfoundCount === 0
          );
        }
      },
        ...
        if (forceNewHashCodes) {
          for (var i1 = 0; i1 < this._lastIndex; i1 = (i1 + 1) | 0) {
            if (newSlots[i1].hashCode !== -1) {
              newSlots[i1].hashCode = this.internalGetHashCode(
                newSlots[i1].value
              );
            }
          }
      ...
      intersectWithEnumerable: function (other) {
        ...
        var intArrayLength = System.Collections.Generic.BitHelper.toIntArrayLength(
          originalLastIndex
        );
        var bitHelper;
        var bitArray = System.Array.init(intArrayLength, 0);
        bitHelper = new System.Collections.Generic.BitHelper(
          bitArray,
          intArrayLength
        );
        $t = Bridge.getEnumerator(other, null, T);
      ...
      symmetricExceptWithEnumerable: function (other) {
        ...
        itemsToRemove = new System.Collections.Generic.BitHelper(
          itemsToRemoveArray,
          intArrayLength
        );
        var itemsAddedFromOtherArray = System.Array.init(intArrayLength, 0);
        itemsAddedFromOther = new System.Collections.Generic.BitHelper(
          itemsAddedFromOtherArray,
          intArrayLength
        );
        $t = Bridge.getEnumerator(other, null, T);
        while ($t.moveNext()) {
      ...
      checkUniqueAndUnfoundElements: function (other, returnIfUnfound) {
        var $t, $t1;
        var result = new (System.Collections.Generic.HashSet$1.ElementCount(
          T
        ))();
        if (this._count === 0) {
        ...
        return (
          this._comparer[
            "System$Collections$Generic$IEqualityComparer$1$" +
              Bridge.getTypeAlias(T) +
              "$getHashCode2"
          ](item) & System.Collections.Generic.HashSet$1(T).Lower31BitMask
        );
      },
    };
  });

  Bridge.define("System.Collections.Generic.HashSet$1.ElementCount", function (
    T
  ) {
    return {
      $kind: "struct",
      statics: {
        getDefaultValue: function () {
          return new (System.Collections.Generic.HashSet$1.ElementCount(T))();
        },
      },
      uniqueCount: 0,
      unfoundCount: 0,
      ...
      equals: function (o) {
        if (
          !Bridge.is(o, System.Collections.Generic.HashSet$1.ElementCount(T))
        ) {
          return false;
        }
        return (
          Bridge.equals(this.uniqueCount, o.uniqueCount) &&
          Bridge.equals(this.unfoundCount, o.unfoundCount)
        );
      },
      $clone: function (to) {
        var s =
          to || new (System.Collections.Generic.HashSet$1.ElementCount(T))();
  ...
  Bridge.define("System.Collections.Generic.HashSet$1.Enumerator", function (
    T
  ) {
    return {
      ...
      statics: {
        getDefaultValue: function () {
          return new (System.Collections.Generic.HashSet$1.Enumerator(T))();
        },
      },
      _set: null,
      _index: 0,
      ...
      equals: function (o) {
        ...
        return (
          Bridge.equals(this._set, o._set) &&
          Bridge.equals(this._index, o._index) &&
          Bridge.equals(this._version, o._version) &&
          Bridge.equals(this._current, o._current)
        );
      },
      $clone: function (to) {
        var s =
          to || new (System.Collections.Generic.HashSet$1.Enumerator(T))();
        s._set = this._set;
  ...
  Bridge.define("System.Collections.Generic.HashSet$1.Slot", function (T) {
    return {
      $kind: "struct",
      statics: {
        getDefaultValue: function () {
      ...
      equals: function (o) {
        ...
        return (
          Bridge.equals(this.hashCode, o.hashCode) &&
          Bridge.equals(this.value, o.value) &&
          Bridge.equals(this.next, o.next)
        );
      },
      $clone: function (to) {
  ...
  Bridge.define("System.Collections.Generic.Queue$1", function (T) {
    return {
      inherits: [
      ...
      $ctor1: function (collection) {
        ...
        this._array = System.Array.init(
          System.Collections.Generic.Queue$1(T).DefaultCapacity,
          function () {
            return Bridge.getDefaultValue(T);
          }
        );
      ...
      copyTo: function (array, arrayIndex) {
        ...
        var numToCopy =
          ((arrayLen - arrayIndex) | 0) < this._size
        ...
        var firstPart =
          ((this._array.length - this._head) | 0) < numToCopy
            ? (this._array.length - this._head) | 0
            : numToCopy;
        System.Array.copy(
          this._array,
        ...
        if (numToCopy > 0) {
          System.Array.copy(
            ...
            0,
            array,
            (((arrayIndex + this._array.length) | 0) - this._head) | 0,
            numToCopy
          );
        }
      },
      enqueue: function (item) {
        if (this._size === this._array.length) {
          var newcapacity =
            Bridge.Int.div(
              (this._array.length *
                System.Collections.Generic.Queue$1(T).GrowFactor) |
                0,
              100
            ) | 0;
          if (
            newcapacity <
            ((this._array.length +
              System.Collections.Generic.Queue$1(T).MinimumGrow) |
              0)
          ) {
            newcapacity =
              (this._array.length +
      ...
      getEnumerator: function () {
        return new (System.Collections.Generic.Queue$1.Enumerator(T).$ctor1)(
          this
        );
      },
      System$Collections$Generic$IEnumerable$1$T$getEnumerator: function () {
  ...
  Bridge.define("System.Collections.Generic.Queue$1.Enumerator", function (T) {
    return {
      inherits: [
      ...
      statics: {
        getDefaultValue: function () {
          return new (System.Collections.Generic.Queue$1.Enumerator(T))();
        },
      },
      _q: null,
      _index: 0,
      ...
      equals: function (o) {
        ...
        return (
          Bridge.equals(this._q, o._q) &&
          Bridge.equals(this._index, o._index) &&
          Bridge.equals(this._version, o._version) &&
          Bridge.equals(this._currentElement, o._currentElement)
        );
      },
      $clone: function (to) {
  ...
  Bridge.define("System.Collections.Generic.Stack$1", function (T) {
    return {
      inherits: [
        System.Collections.Generic.IEnumerable$1(T),
        System.Collections.ICollection,
      ...
      $ctor1: function (collection) {
        ...
        var length = {};
        this._array = Bridge.Collections.EnumerableHelpers.toArray$1(
          T,
          collection,
          length
        );
      ...
      copyTo: function (array, arrayIndex) {
        ...
        if (!Bridge.referenceEquals(array, this._array)) {
          ...
          for (var i = 0; i < this._size; i = (i + 1) | 0) {
            array[(dstIndex = (dstIndex - 1) | 0)] = this._array[
              Bridge.identity(srcIndex, (srcIndex = (srcIndex + 1) | 0))
            ];
          }
        } else {
      ...
      getEnumerator: function () {
        return new (System.Collections.Generic.Stack$1.Enumerator(T).$ctor1)(
          this
        );
      },
      System$Collections$Generic$IEnumerable$1$T$getEnumerator: function () {
        ...
        if (this._size === this._array.length) {
          ...
          System.Array.resize(
            ...
            this._array.length === 0
              ? System.Collections.Generic.Stack$1(T).DefaultCapacity
              : (2 * this._array.length) | 0,
            Bridge.getDefaultValue(T)
          );
          this._array = localArray.v;
        }
        this._array[
          Bridge.identity(this._size, (this._size = (this._size + 1) | 0))
        ] = item;
        this._version = (this._version + 1) | 0;
      },
      toArray: function () {
  ...
  Bridge.define("System.Collections.Generic.Stack$1.Enumerator", function (T) {
    return {
      inherits: [
        System.Collections.Generic.IEnumerator$1(T),
        System.Collections.IEnumerator,
      ...
      statics: {
        getDefaultValue: function () {
          return new (System.Collections.Generic.Stack$1.Enumerator(T))();
        },
      },
      _stack: null,
      _index: 0,
      ...
      equals: function (o) {
        ...
        return (
          Bridge.equals(this._stack, o._stack) &&
          Bridge.equals(this._index, o._index) &&
          Bridge.equals(this._version, o._version) &&
          Bridge.equals(this._currentElement, o._currentElement)
        );
  ...
  Bridge.define("System.Collections.HashHelpers", {
    statics: {
      ...
      getPrime: function (min) {
        ...
        for (
          var i = 0;
          i < System.Collections.HashHelpers.primes.length;
          i = (i + 1) | 0
        ) {
        ...
        for (var i1 = min | 1; i1 < 2147483647; i1 = (i1 + 2) | 0) {
          if (
            System.Collections.HashHelpers.isPrime(i1) &&
            ((i1 - 1) | 0) % System.Collections.HashHelpers.HashPrime !== 0
          ) {
            return i1;
          }
        }
      ...
      expandPrime: function (oldSize) {
        ...
        if (
          newSize >>> 0 > System.Collections.HashHelpers.MaxPrimeArrayLength &&
          System.Collections.HashHelpers.MaxPrimeArrayLength > oldSize
        ) {
