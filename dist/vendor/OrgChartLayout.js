 ...
 */
bridge_1.Bridge.assembly("OrgChart.Layout", function ($asm, globals) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Annotations.CanBeNullAttribute", {
        inherits: [bridge_1.System.Attribute],
    });
    /**
     ...
     * @augments System.Attribute
     */
    bridge_1.Bridge.define("OrgChart.Annotations.ContractAnnotationAttribute", {
        inherits: [bridge_1.System.Attribute],
        config: {
            properties: {
                /**
        ...
        ctor: function (contract) {
            OrgChart.Annotations.ContractAnnotationAttribute.$ctor1.call(this, contract, false);
        },
        /**
         * Ctr.
         *
        ...
        $ctor1: function (contract, forceFullStates) {
            this.$initialize();
            bridge_1.System.Attribute.ctor.call(this);
     ...
     * @augments System.Attribute
     */
    bridge_1.Bridge.define("OrgChart.Annotations.NotNullAttribute", {
        inherits: [bridge_1.System.Attribute],
    });
    /**
     ...
     *
     */
    bridge_1.Bridge.define("OrgChart.Annotations.PureAttribute", {
        inherits: [bridge_1.System.Attribute],
    });
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Boundary", {
        /**
        ...
        $ctor1: function (frompublic) {
            this.$initialize();
            this.Left = new (bridge_1.System.Collections.Generic.List$1(OrgChart.Layout.Boundary.Step))();
            this.Right = new (bridge_1.System.Collections.Generic.List$1(OrgChart.Layout.Boundary.Step))();
            if (frompublic) {
        ...
        MergeFrom: function (other) {
            if (other.getBoundingRect().getTop() >= other.getBoundingRect().getBottom()) {
                throw new bridge_1.System.ArgumentException("Cannot merge boundary of height " +
                    bridge_1.System.Double.format(other.getBoundingRect().getBottom() -
                        other.getBoundingRect().getTop(), "G"));
            }
            var merge = 114;
            while (merge !== 0) {
                ...
                for (; k < theirSteps.getCount() && i < mySteps.getCount();) {
                    ...
                    if (OrgChart.Layout.LayoutAlgorithm.IsEqual(my.Top, th.Top)) {
                        ...
                        if (theirWins) {
                            ...
                            mySteps.insert((i + 1) | 0, new OrgChart.Layout.Boundary.Step.$ctor1(th.Node, th.X, th.Top, my.Bottom)); // insert a piece of theirs after my
                            i = (i + 1) | 0;
                        }
        ...
        ValidateState: function () {
            for (var i = 1; i < this.Left.getCount(); i = (i + 1) | 0) {
                if (OrgChart.Layout.LayoutAlgorithm.IsEqual(this.Left.getItem(i).Top, this.Left.getItem(i).Bottom) ||
                    ...
                    throw new bridge_1.System.Exception("State error at Left index " + i);
                }
            }
            for (var i1 = 1; i1 < this.Right.getCount(); i1 = (i1 + 1) | 0) {
                if (OrgChart.Layout.LayoutAlgorithm.IsEqual(this.Right.getItem(i1).Top, this.Right.getItem(i1).Bottom) ||
                    ...
                    this.Right.getItem(i1).Bottom <=
                        this.Right.getItem((i1 - 1) | 0).Bottom) {
                    throw new bridge_1.System.Exception("State error at Right index " + i1);
                }
            }
        },
        /**
        ...
        ComputeOverlap: function (other, siblingSpacing, branchSpacing) {
            ...
            while (i < this.Right.getCount() && k < other.Left.getCount()) {
                ...
                if (my.Bottom <= th.Top) {
                    ...
                    if (!my.Node.getElement().DisableCollisionDetection &&
                        !th.Node.getElement().DisableCollisionDetection) {
                        var desiredSpacing = my.Node.getElement().IsSpecial || th.Node.getElement().IsSpecial
                            ? 0
        ...
        ReloadFromBranch: function (branchRoot) {
            var leftmost = bridge_1.System.Double.max;
            var rightmost = bridge_1.System.Double.min;
            ...
            this.setBoundingRect(new OrgChart.Layout.Rect.$ctor1(new OrgChart.Layout.Point.$ctor1(leftmost, this.getBoundingRect().getTop()), new OrgChart.Layout.Size.$ctor1(rightmost - leftmost, this.getBoundingRect().Size.Height)));
        },
    });
    /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Boundary.Step", {
        $kind: "struct",
        statics: {
        ...
        equals: function (o) {
            if (!bridge_1.Bridge.is(o, OrgChart.Layout.Boundary.Step)) {
                return false;
            }
            return (bridge_1.Bridge.equals(this.Node, o.Node) &&
                bridge_1.Bridge.equals(this.X, o.X) &&
                bridge_1.Bridge.equals(this.Top, o.Top) &&
                bridge_1.Bridge.equals(this.Bottom, o.Bottom));
        },
        $clone: function (to) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.BoundaryChangedEventArgs", {
        /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Box", {
        statics: {
            /**
            ...
            Special: function (id, visualParentId, disableCollisionDetection) {
                return new OrgChart.Layout.Box.$ctor1(null, id, visualParentId, true, disableCollisionDetection, false);
            },
        },
        /**
        ...
        ctor: function (dataId, id, parentId, isAssistant) {
            OrgChart.Layout.Box.$ctor1.call(this, dataId, id, parentId, false, false, isAssistant);
        },
        $ctor1: function (dataId, id, parentId, isSpecial, disableCollisionDetection, isAssistant) {
            this.$initialize();
            if (id === 0) {
                throw new bridge_1.System.ArgumentOutOfRangeException("id");
            }
            this.Id = id;
        ...
        getIsDataBound: function () {
            return !bridge_1.System.String.isNullOrEmpty(this.DataId);
        },
    });
    /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.BoxContainer", {
        m_lastBoxId: 0,
        m_boxesById: null,
        ...
        config: {
            ...
            init: function () {
                this.m_boxesById = new (bridge_1.System.Collections.Generic.Dictionary$2(bridge_1.System.Int32, OrgChart.Layout.Box))();
                this.m_boxesByDataId = new (bridge_1.System.Collections.Generic.Dictionary$2(String, OrgChart.Layout.Box))();
            },
        },
        /**
         * Ctr.
        ...
        ReloadBoxes: function (source) {
            ...
            this.setSystemRoot(OrgChart.Layout.Box.Special((this.m_lastBoxId = (this.m_lastBoxId + 1) | 0), OrgChart.Layout.Box.None, true));
            this.m_boxesById.add(this.getSystemRoot().Id, this.getSystemRoot());
            var map = new (bridge_1.System.Collections.Generic.Dictionary$2(String, bridge_1.System.Int32))();
            // generate identifiers mapping, need this because data comes in random order
            $t = bridge_1.Bridge.getEnumerator(source.OrgChart$Layout$IChartDataSource$getAllDataItemIds(), String);
            while ($t.moveNext()) {
            ...
            $t1 = bridge_1.Bridge.getEnumerator(source.OrgChart$Layout$IChartDataSource$getAllDataItemIds(), String);
            while ($t1.moveNext()) {
                var dataId1 = $t1.getCurrent();
                var parentDataId = bridge_1.System.String.isNullOrEmpty(dataId1)
                    ? null
                    : source.OrgChart$Layout$IChartDataSource$getGetParentKeyFunc()(dataId1);
                var visualParentId = bridge_1.System.String.isNullOrEmpty(parentDataId)
        ...
        AddBox$1: function (dataId, id, visualParentId, isAssistant) {
            ...
            if (!bridge_1.System.String.isNullOrEmpty(dataId)) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.BoxTree", {
        statics: {
            /**
            ...
            Build: function (state) {
                ...
                $t = bridge_1.Bridge.getEnumerator(state
                    .getDiagram()
                    .getBoxes()
                    .getBoxesById()
                    .System$Collections$Generic$IDictionary$2$System$Int32$OrgChart$Layout$Box$getValues(), OrgChart.Layout.Box);
                while ($t.moveNext()) {
                ...
                // build the tree
                $t1 = bridge_1.Bridge.getEnumerator(result.getNodes().getValues(), OrgChart.Layout.BoxTree.Node);
                while ($t1.moveNext()) {
                    var node1 = $t1.getCurrent();
                    var parentKey = node1.getElement().ParentId;
                    var parentNode = {};
                    if (result.getNodes().tryGetValue(parentKey, parentNode)) {
                        if (node1.getElement().IsAssistant &&
                        ...
                        if (result.getRoot() != null) {
                            throw new bridge_1.System.InvalidOperationException("More then one root found: " + node1.getElement().Id);
                        }
        ...
        ctor: function () {
            this.$initialize();
            this.setNodes(new (bridge_1.System.Collections.Generic.Dictionary$2(bridge_1.System.Int32, OrgChart.Layout.BoxTree.Node))());
        },
        /**
        ...
        UpdateHierarchyStats: function () {
            ...
            this.setDepth(0);
            this.IterateParentFirst(bridge_1.Bridge.fn.bind(this, $asm.$.OrgChart.Layout.BoxTree.f1));
        },
    });
    bridge_1.Bridge.ns("OrgChart.Layout.BoxTree", $asm.$);
    bridge_1.Bridge.apply($asm.$.OrgChart.Layout.BoxTree, {
        f1: function (x) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.BoxTree.Node", {
        config: {
            properties: {
                /**
                 * Hierarchy level.
        ...
        getChildCount: function () {
            return this.getChildren() == null
                ? 0
                : bridge_1.System.Array.getCount(this.getChildren(), OrgChart.Layout.BoxTree.Node);
        },
        /**
        ...
        getIsAssistantRoot: function () {
            var $t;
            return bridge_1.Bridge.referenceEquals(($t = this.getParentNode()) != null ? $t.getAssistantsRoot() : null, this);
        },
        /**
        ...
        AddAssistantChild: function (child) {
            if (this.getAssistantsRoot() == null) {
                this.setAssistantsRoot(bridge_1.Bridge.merge(new OrgChart.Layout.BoxTree.Node(OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, this.getElement().Id, true)), {
                    setParentNode: this,
        ...
        InsertRegularChild$1: function (index, child) {
            if (this.getChildren() == null) {
                this.setChildren(new (bridge_1.System.Collections.Generic.List$1(OrgChart.Layout.BoxTree.Node))());
            }
            bridge_1.System.Array.insert(this.getChildren(), index, child, OrgChart.Layout.BoxTree.Node);
        ...
        IterateChildFirst: function (func) {
            ...
            if (this.getChildren() != null) {
                $t = bridge_1.Bridge.getEnumerator(this.getChildren(), OrgChart.Layout.BoxTree.Node);
                while ($t.moveNext()) {
        ...
        IterateParentFirst: function (enter, exit) {
            ...
            if (!enter(this)) {
                !bridge_1.Bridge.staticEquals(exit, null) ? exit(this) : null;
                return false;
            }
            ($t = this.getAssistantsRoot()) != null
                ...
                : null;
            if (this.getChildren() != null) {
                $t1 = bridge_1.Bridge.getEnumerator(this.getChildren(), OrgChart.Layout.BoxTree.Node);
                while ($t1.moveNext()) {
        ...
        SuppressAssistants: function () {
            var $t;
            if (this.getAssistantsRoot() != null) {
                $t = bridge_1.Bridge.getEnumerator(this.getAssistantsRoot().getChildren(), OrgChart.Layout.BoxTree.Node);
                while ($t.moveNext()) {
                    var child = $t.getCurrent();
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.BranchParentAlignment", {
        $kind: "enum",
        statics: {
            /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Connector", {
        config: {
            properties: {
                /**
        ...
        ctor: function (segments) {
            ...
            if (segments.length === 0) {
                throw new bridge_1.System.ArgumentException("Need at least one segment", "segments");
            }
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Diagram", {
        m_visualTree: null,
        m_boxes: null,
        config: {
            properties: {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.DiagramLayoutSettings", {
        m_branchSpacing: 0,
        config: {
            properties: {
                /**
        ...
        ctor: function () {
            ...
            this.setLayoutStrategies(new (bridge_1.System.Collections.Generic.Dictionary$2(String, OrgChart.Layout.LayoutStrategyBase))());
        },
        /**
        ...
        setBranchSpacing: function (value) {
            if (value < 0) {
                throw new bridge_1.System.ArgumentOutOfRangeException("value", "Cannot be negative", null, value);
            }
        ...
        RequireDefaultLayoutStrategy: function () {
            var result = {};
            if (bridge_1.System.String.isNullOrEmpty(this.getDefaultLayoutStrategyId()) ||
                !this.getLayoutStrategies().tryGetValue(this.getDefaultLayoutStrategyId(), result)) {
                throw new bridge_1.System.InvalidOperationException("defaultLayoutStrategyId is null or not valid");
            }
            return result.v;
        },
        /**
        ...
        RequireDefaultAssistantLayoutStrategy: function () {
            var result = {};
            if (bridge_1.System.String.isNullOrEmpty(this.getDefaultAssistantLayoutStrategyId()) ||
                !this.getLayoutStrategies().tryGetValue(this.getDefaultAssistantLayoutStrategyId(), result)) {
                throw new bridge_1.System.InvalidOperationException("defaultAssistantLayoutStrategyId is null or not valid");
            }
            return result.v;
        },
    });
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.DiagramLayoutTemplates");
    /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Dimensions", {
        $kind: "struct",
        statics: {
            /**
             * Ctr.
             ...
             */
            MinMax: function () {
                return new OrgChart.Layout.Dimensions.$ctor1(bridge_1.System.Double.max, bridge_1.System.Double.min);
            },
            /**
        ...
        getHashCode: function () {
            var h = bridge_1.Bridge.addHash([3570880544, this.From, this.To]);
            return h;
        },
        equals: function (o) {
            if (!bridge_1.Bridge.is(o, OrgChart.Layout.Dimensions)) {
                return false;
            }
            return bridge_1.Bridge.equals(this.From, o.From) && bridge_1.Bridge.equals(this.To, o.To);
        },
        $clone: function (to) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Edge", {
        $kind: "struct",
        statics: {
            getDefaultValue: function () {
        ...
        getHashCode: function () {
            var h = bridge_1.Bridge.addHash([1701274693, this.From, this.To]);
            return h;
        },
        equals: function (o) {
            if (!bridge_1.Bridge.is(o, OrgChart.Layout.Edge)) {
                return false;
            }
            return bridge_1.Bridge.equals(this.From, o.From) && bridge_1.Bridge.equals(this.To, o.To);
        },
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.LayoutStrategyBase", {
        /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Frame1", {
        /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.IChartDataItem", {
        $kind: "interface",
    });
    /**
     * Access to underlying data.
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.IChartDataSource", {
        $kind: "interface",
    });
    /**
     * Applies layout.
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.LayoutAlgorithm", {
        statics: {
            /**
            ...
            ComputeBranchVisualBoundingRect: function (visualTree) {
                ...
                visualTree.getRoot().IterateParentFirst(function (node) {
                    ...
                    if (!node.getState().IsHidden && !box.IsSpecial) {
                        if (initialized) {
                            result = OrgChart.Layout.Rect.op_Addition(result, new OrgChart.Layout.Rect.$ctor1(node.getState().TopLeft, node.getState().Size));
                        }
                        else {
                            initialized = true;
                            result = new OrgChart.Layout.Rect.$ctor1(node.getState().TopLeft, node.getState().Size);
                        }
                    }
            ...
            Apply: function (state) {
                ...
                if (state.getDiagram().getBoxes().getSystemRoot() == null) {
                    throw new bridge_1.System.InvalidOperationException("SystemRoot is not initialized on the box container");
                }
                ...
                if (tree.getRoot() == null ||
                    ...
                    throw new bridge_1.System.Exception("SystemRoot is not on the top of the visual tree");
                }
                ...
                if (!bridge_1.Bridge.staticEquals(state.getBoxSizeFunc(), null)) {
                    // apply box sizes
                    $t = bridge_1.Bridge.getEnumerator(bridge_1.System.Linq.Enumerable.from(state
                        .getDiagram()
                        .getBoxes()
                        .getBoxesById()
                        .System$Collections$Generic$IDictionary$2$System$Int32$OrgChart$Layout$Box$getValues()).where($asm.$.OrgChart.Layout.LayoutAlgorithm.f2));
                    while ($t.moveNext()) {
                        var box = $t.getCurrent();
                        box.Size = state.getBoxSizeFunc()(box.DataId);
                    }
                }
                $t1 = bridge_1.Bridge.getEnumerator(state
                    .getDiagram()
                    .getBoxes()
                    .getBoxesById()
                    .System$Collections$Generic$IDictionary$2$System$Int32$OrgChart$Layout$Box$getValues(), OrgChart.Layout.Box);
            ...
            AssertBoxSize: function (box) {
                ...
                throw new bridge_1.System.InvalidOperationException(bridge_1.System.String.format("Box {0} has invalid size: {1}x{2}", box.Id, box.Size.Width, box.Size.Height));
            },
            PreprocessVisualTree: function (state, visualTree) {
                ...
                var regular = new (bridge_1.System.Collections.Generic.Stack$1(OrgChart.Layout.LayoutStrategyBase).ctor)();
                regular.push(defaultStrategy);
                var assistants = new (bridge_1.System.Collections.Generic.Stack$1(OrgChart.Layout.LayoutStrategyBase).ctor)();
                ...
                visualTree.IterateParentFirst(function (node) {
                    ...
                    var strategy = null;
                    if (!bridge_1.Bridge.staticEquals(state.getLayoutOptimizerFunc(), null)) {
                        var suggestedStrategyId = state.getLayoutOptimizerFunc()(node);
                        if (!bridge_1.System.String.isNullOrEmpty(suggestedStrategyId)) {
                            strategy = state
                                .getDiagram()
                                .getLayoutSettings()
                                .getLayoutStrategies()
                            ...
                            strategy =
                                node.getParentNode().getElement().AssistantLayoutStrategyId !=
                                    ...
                                    ? state
                                        ...
                                        .getLayoutSettings()
                                        .getLayoutStrategies()
                                        .get(node.getParentNode().getElement()
            ...
            HorizontalLayout: function (state, branchRoot) {
                if (branchRoot.getState().IsHidden) {
                    throw new bridge_1.System.InvalidOperationException(bridge_1.System.String.format("Branch root {0} does not affect layout", branchRoot.getElement().Id));
                }
                var level = state.PushLayoutLevel(branchRoot);
                try {
                    if (branchRoot.getLevel() === 0 ||
            ...
            MoveChildrenOnly: function (state, layoutLevel, offset) {
                ...
                if (children == null ||
                    bridge_1.System.Array.getCount(children, OrgChart.Layout.BoxTree.Node) === 0) {
                    throw new bridge_1.System.InvalidOperationException("Should never be invoked when children not set");
                }
                ...
                $t = bridge_1.Bridge.getEnumerator(children, OrgChart.Layout.BoxTree.Node);
                while ($t.moveNext()) {
                    var child = $t.getCurrent();
            ...
            AlignHorizontalCenters: function (state, level, subset) {
                ...
                var center = bridge_1.System.Double.min;
                $t = bridge_1.Bridge.getEnumerator(subset, OrgChart.Layout.BoxTree.Node);
                while ($t.moveNext()) {
                    var child = $t.getCurrent();
                ...
                var leftmost = bridge_1.System.Double.max;
                var rightmost = bridge_1.System.Double.min;
                $t1 = bridge_1.Bridge.getEnumerator(subset, OrgChart.Layout.BoxTree.Node);
                while ($t1.moveNext()) {
            ...
            IsMinValue: function (value) {
                return value <= bridge_1.System.Double.min + 4.94065645841247e-324;
            },
            /**
             * <pre><code>true</code></pre> if specified <b /> is equal to {@link }.
             *
            ...
            IsMaxValue: function (value) {
                return value >= bridge_1.System.Double.max - 4.94065645841247e-324;
            },
            /**
             * <pre><code>true</code></pre> if specified <b /> is equal to {@link }.
             *
            ...
            IsZero: function (value) {
                return (value <= 4.94065645841247e-324 && value >= -4.94065645841247e-324);
            },
            /**
             * <pre><code>true</code></pre> if specified <b /> is equal to {@link }.
             *
    ...
    bridge_1.Bridge.ns("OrgChart.Layout.LayoutAlgorithm", $asm.$);
    bridge_1.Bridge.apply($asm.$.OrgChart.Layout.LayoutAlgorithm, {
        f1: function (node) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.LayoutState", {
        /**
        ...
        config: {
            ...
            init: function () {
                this.m_layoutStack = new (bridge_1.System.Collections.Generic.Stack$1(OrgChart.Layout.LayoutState.LayoutLevel).ctor)();
                this.m_pooledBoundaries = new (bridge_1.System.Collections.Generic.Stack$1(OrgChart.Layout.Boundary).ctor)();
            },
        },
        /**
         * Ctr.
        ...
        setCurrentOperation: function (value) {
            ...
            !bridge_1.Bridge.staticEquals(this.OperationChanged, null)
        ...
        PushLayoutLevel: function (node) {
            ...
            switch (this.getCurrentOperation()) {
                ...
                case OrgChart.Layout.LayoutState.Operation.HorizontalLayout:
                    ...
                    break;
                default:
                    throw new bridge_1.System.InvalidOperationException("This operation can only be invoked when performing vertical or horizontal layouts");
            }
            var result = new OrgChart.Layout.LayoutState.LayoutLevel(node, boundary);
            this.m_layoutStack.push(result);
            !bridge_1.Bridge.staticEquals(this.BoundaryChanged, null)
        ...
        MergeSpacer: function (spacer) {
            if (this.getCurrentOperation() !==
                ...
                throw new bridge_1.System.InvalidOperationException("Spacers can only be merged during horizontal layout");
            }
            if (this.m_layoutStack.getCount() === 0) {
                throw new bridge_1.System.InvalidOperationException("Cannot merge spacers at top nesting level");
            }
                    ...
                    case OrgChart.Layout.LayoutState.Operation.HorizontalLayout:
                        {
                            ...
                            if (!bridge_1.Bridge.referenceEquals(higherLevel.BranchRoot.getAssistantsRoot(), innerLevel.BranchRoot)) {
                            ...
                            higherLevel.BranchRoot.getState().BranchExterior = new OrgChart.Layout.Rect.$ctor3(higherLevel.Boundary.getBoundingRect().getLeft(), higherLevel.BranchRoot.getState().BranchExterior.getTop(), higherLevel.Boundary.getBoundingRect().Size.Width, higherLevel.BranchRoot.getState().BranchExterior.Size.Height);
                        }
                        break;
                    default:
                        throw new bridge_1.System.InvalidOperationException("This operation can only be invoked when performing vertical or horizontal layouts");
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.LayoutState.LayoutLevel", {
        /**
     ...
     * @class number
     */
    bridge_1.Bridge.define("OrgChart.Layout.LayoutState.Operation", {
        $kind: "enum",
        statics: {
            /**
             * No op.
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.LayoutStateOperationChangedEventArgs", {
        /**
         * Current layout state.
         *
         * @instance
    ...
    bridge_1.Bridge.define("OrgChart.Layout.MultiLineFishboneLayoutStrategy.SingleFishboneLayoutAdapter.GroupIterator", {
        ...
        CountInGroup: function () {
            ...
            var firstInRow = 0;
            while (true) {
                var countInThisRow = firstInRow >= ((this.m_numberOfSiblings - countInRow) | 0)
        ...
        NextGroup: function () {
            ...
            this.MaxOnLeft =
                ((bridge_1.Bridge.Int.div(this.Count, 2) | 0) + (this.Count % 2)) | 0;
            return this.Count !== 0;
        },
    });
    /**
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.NodeLayoutInfo", {
        /**
        ...
        RequireLayoutStrategy: function () {
            if (this.m_effectiveLayoutStrategy == null) {
                throw new bridge_1.System.Exception("effectiveLayoutStrategy is not set");
            }
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Point", {
        $kind: "struct",
        statics: {
            getDefaultValue: function () {
        ...
        getHashCode: function () {
            var h = bridge_1.Bridge.addHash([1852403652, this.X, this.Y]);
            return h;
        },
        equals: function (o) {
            if (!bridge_1.Bridge.is(o, OrgChart.Layout.Point)) {
                return false;
            }
            return bridge_1.Bridge.equals(this.X, o.X) && bridge_1.Bridge.equals(this.Y, o.Y);
        },
        $clone: function (to) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Rect", {
        $kind: "struct",
        statics: {
            /**
        ...
        $ctor3: function (x, y, w, h) {
            this.$initialize();
            if (w < 0) {
                throw new bridge_1.System.ArgumentOutOfRangeException("w");
            }
            if (h < 0) {
                throw new bridge_1.System.ArgumentOutOfRangeException("h");
            }
        ...
        getHashCode: function () {
            var h = bridge_1.Bridge.addHash([1952671058, this.TopLeft, this.Size]);
            return h;
        },
        equals: function (o) {
            if (!bridge_1.Bridge.is(o, OrgChart.Layout.Rect)) {
                return false;
            }
            return (bridge_1.Bridge.equals(this.TopLeft, o.TopLeft) &&
                bridge_1.Bridge.equals(this.Size, o.Size));
        },
        $clone: function (to) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.Size", {
        $kind: "struct",
        statics: {
            getDefaultValue: function () {
        ...
        getHashCode: function () {
            var h = bridge_1.Bridge.addHash([1702521171, this.Width, this.Height]);
            return h;
        },
        equals: function (o) {
            if (!bridge_1.Bridge.is(o, OrgChart.Layout.Size)) {
                return false;
            }
            return (bridge_1.Bridge.equals(this.Width, o.Width) &&
                bridge_1.Bridge.equals(this.Height, o.Height));
        },
        $clone: function (to) {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.StackOrientation", {
        $kind: "enum",
        statics: {
            /**
             * Default value is invalid, do not use it.
     ...
     */
    bridge_1.Bridge.define("OrgChart.Test.TestDataGen", {
        statics: {
            /**
            ...
            GenerateBoxSizes: function (boxContainer) {
                ...
                bridge_1.System.Diagnostics.Debug.writeln(seed.toString());
                var random = new bridge_1.System.Random.$ctor1(seed);
                $t = bridge_1.Bridge.getEnumerator(boxContainer
                    .getBoxesById()
                    .System$Collections$Generic$IDictionary$2$System$Int32$OrgChart$Layout$Box$getValues(), OrgChart.Layout.Box);
                while ($t.moveNext()) {
                    var box = $t.getCurrent();
                    if (!box.IsSpecial) {
                        box.Size = new OrgChart.Layout.Size.$ctor1((minWidth + random.next$1(widthVariation)) | 0, (minHeight + random.next$1(heightVariation)) | 0);
                    }
                }
            },
        },
        ...
        GenerateDataItems: function (dataSource, count, percentAssistants) {
            var $t;
            $t = bridge_1.Bridge.getEnumerator(this.GenerateRandomDataItems(count, percentAssistants));
            while ($t.moveNext()) {
        ...
        GenerateRandomDataItems: function (itemCount, percentAssistants) {
            if (itemCount < 0) {
                throw new bridge_1.System.ArgumentOutOfRangeException("itemCount", "Count must be zero or positive", null, itemCount);
            }
            var random = new bridge_1.System.Random.$ctor1(0);
            var items = new (bridge_1.System.Collections.Generic.List$1(OrgChart.Test.TestDataItem))(itemCount);
            for (var i = 0; i < itemCount; i = (i + 1) | 0) {
                items.add(bridge_1.Bridge.merge(new OrgChart.Test.TestDataItem(), {
                    setId: i.toString(),
                }));
            }
            var firstInLayer = 1;
            ...
            while (firstInLayer < itemCount) {
                var layerSize = (((15 + prevLayerSize) | 0) +
            ...
            for (var i2 = 0; i2 < (bridge_1.Bridge.Int.div(items.getCount(), 2) | 0); i2 = (i2 + 1) | 0) {
            ...
            if (percentAssistants > 0) {
                var assistantCount = Math.min(items.getCount(), bridge_1.Bridge.Int.clip32(Math.ceil(((items.getCount() * percentAssistants) | 0) / 100.0)));
     ...
     * @augments System.Attribute
     */
    bridge_1.Bridge.define("System.Diagnostics.DebuggerDisplayAttribute", {
        inherits: [bridge_1.System.Attribute],
        /**
         * Stub.
         *
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.FishboneAssistantsLayoutStrategy", {
        ...
        PreProcessThisNode: function (state, node) {
            ...
            if (node.getState().NumberOfSiblings > 0) {
                ...
                node.getState().NumberOfSiblingRows =
                    bridge_1.Bridge.Int.div(node.getState().NumberOfSiblings, 2) | 0;
                if (node.getState().NumberOfSiblings % 2 !== 0) {
                    node.getState().NumberOfSiblingRows =
                        (node.getState().NumberOfSiblingRows + 1) | 0;
                }
                // a vertical carrier from parent
                var spacer = OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, node.getElement().Id, false);
        ...
        ApplyVerticalLayout: function (state, level) {
            ...
            if (node.getLevel() === 0) {
                throw new bridge_1.System.InvalidOperationException("Should never be invoked on root node");
            }
            ...
            for (var i = 0; i < maxOnLeft; i = (i + 1) | 0) {
                ...
                var child = bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node);
                ...
                if (i2 < node.getState().NumberOfSiblings) {
                    var child2 = bridge_1.System.Array.getItem(node.getChildren(), i2, OrgChart.Layout.BoxTree.Node);
                    ...
                    if (frame2.getBottom() > frame.getBottom()) {
                        ...
                        OrgChart.Layout.LayoutAlgorithm.MoveTo(frame2, frame2.getLeft(), frame.getCenterV() - frame2.Size.Height / 2);
                    }
                    frame2.BranchExterior = new OrgChart.Layout.Rect.$ctor1(frame2.TopLeft, frame2.Size);
                    rowExterior = OrgChart.Layout.Dimensions.op_Addition(rowExterior, new OrgChart.Layout.Dimensions.$ctor1(frame2.getTop(), frame2.getBottom()));
        ...
        ApplyHorizontalLayout: function (state, level) {
            ...
            for (var i = 0; i < node.getState().NumberOfSiblings; i = (i + 1) | 0) {
                ...
                if ((countOnThisSide = (countOnThisSide + 1) | 0) === maxOnLeft) {
                    if (left) {
                        ...
                        OrgChart.Layout.LayoutAlgorithm.AlignHorizontalCenters(state, level, this.EnumerateSiblings(node, 0, maxOnLeft));
                        left = false;
                        countOnThisSide = 0;
                        var rightmost = bridge_1.System.Double.min;
                        for (var k = 0; k <= i; k = (k + 1) | 0) {
                            rightmost = Math.max(rightmost, bridge_1.System.Array.getItem(node.getChildren(), k, OrgChart.Layout.BoxTree.Node)
                                .getState()
                        ...
                        if (node.getState().NumberOfSiblings % 2 !== 0) {
                            ...
                            var opposite = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings - 1) | 0, OrgChart.Layout.BoxTree.Node);
                            if (opposite.getElement().IsCollapsed ||
                                opposite.getChildCount() === 0) {
                                rightmost = Math.max(rightmost, child.getState().getRight());
                            }
                            else {
                                rightmost = Math.max(rightmost, child.getState().BranchExterior.getRight());
                            }
                        }
                        ...
                        var spacer = bridge_1.System.Array.getItem(node.getChildren(), node.getState().NumberOfSiblings, OrgChart.Layout.BoxTree.Node);
                        OrgChart.Layout.LayoutAlgorithm.AdjustSpacer(spacer.getState(), rightmost, node.getState().getBottom(), this.ParentConnectorShield, node.getState().BranchExterior.getBottom() -
            ...
            OrgChart.Layout.LayoutAlgorithm.AlignHorizontalCenters(state, level, this.EnumerateSiblings(node, maxOnLeft, node.getState().NumberOfSiblings));
            // align children under parent
            if (node.getLevel() > 0 && node.getState().NumberOfSiblings > 0) {
                var diff;
                var carrier = bridge_1.System.Array.getItem(node.getChildren(), node.getState().NumberOfSiblings, OrgChart.Layout.BoxTree.Node)
                    .getState()
                    .getCenterH();
        ...
        RouteConnectors: function (state, node) {
            ...
            var segments = bridge_1.System.Array.init(count, function () {
                return new OrgChart.Layout.Edge();
            });
            var ix = 0;
            // one hook for each child
            var maxOnLeft = this.MaxOnLeft(node);
            var carrier = bridge_1.System.Array.getItem(node.getChildren(), node.getState().NumberOfSiblings, OrgChart.Layout.BoxTree.Node).getState();
            var from = carrier.getCenterH();
            var isLeft = true;
            var countOnThisSide = 0;
            var bottomMost = bridge_1.System.Double.min;
            for (var i = 0; i < node.getState().NumberOfSiblings; i = (i + 1) | 0) {
                var to = isLeft
                    ? bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getRight()
                    : bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getLeft();
                var y = bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node)
                    .getState()
                    .getCenterV();
                bottomMost = Math.max(bottomMost, y);
                segments[bridge_1.Bridge.identity(ix, (ix = (ix + 1) | 0))] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(from, y), new OrgChart.Layout.Point.$ctor1(to, y));
                if ((countOnThisSide = (countOnThisSide + 1) | 0) === maxOnLeft) {
                    countOnThisSide = 0;
                    isLeft = !isLeft;
                }
            ...
            if (this.NeedCarrierProtector(node)) {
                ...
                segments[node.getState().NumberOfSiblings] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(carrier.getCenterH(), carrier.getTop()), new OrgChart.Layout.Point.$ctor1(carrier.getCenterH(), bottomMost));
            }
            node.getState().Connector = new OrgChart.Layout.Connector(segments);
        },
        MaxOnLeft: function (node) {
            return (((bridge_1.Bridge.Int.div(node.getState().NumberOfSiblings, 2) | 0) +
        ...
        EnumerateSiblings: function (node, from, to) {
            ...
            for (var i = from; i < to; i = (i + 1) | 0) {
                $yield.push(bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node));
            }
            return bridge_1.System.Array.toEnumerable($yield);
        },
    });
    /**
     ...
     * @augments OrgChart.Layout.LayoutStrategyBase
     */
    bridge_1.Bridge.define("OrgChart.Layout.LinearLayoutStrategy", {
        inherits: [OrgChart.Layout.LayoutStrategyBase],
        /**
           * <pre><code>true</code></pre> if this strategy supports special layout for assistant boxes.
           If not, assistants will be processed as part of normal children group.
        ...
        PreProcessThisNode: function (state, node) {
            if (node.getChildCount() > 0) {
                ...
                // only add spacers for non-collapsed boxes
                if (!node.getElement().IsCollapsed) {
                    var verticalSpacer = OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, node.getElement().Id, false);
                    node.AddRegularChild(verticalSpacer);
                    var horizontalSpacer = OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, node.getElement().Id, false);
        ...
        ApplyVerticalLayout: function (state, level) {
            ...
            var top = node.getAssistantsRoot() == null
            ...
            for (var i1 = 0; i1 < node.getState().NumberOfSiblings; i1 = (i1 + 1) | 0) {
                var child1 = bridge_1.System.Array.getItem(node.getChildren(), i1, OrgChart.Layout.BoxTree.Node);
        ...
        ApplyHorizontalLayout: function (state, level) {
            ...
            if (node.getLevel() > 0 && node.getChildCount() > 0) {
                var rect = node.getState();
                var leftmost = bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node)
                    .getState()
                    .getCenterH();
                var rightmost = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings - 1) | 0, OrgChart.Layout.BoxTree.Node)
                    .getState()
                    .getCenterH();
                var desiredCenter = node.getState().NumberOfSiblings === 1 ||
                ...
                var verticalSpacer = bridge_1.System.Array.getItem(node.getChildren(), node.getState().NumberOfSiblings, OrgChart.Layout.BoxTree.Node);
                OrgChart.Layout.LayoutAlgorithm.AdjustSpacer(verticalSpacer.getState(), center - this.ParentConnectorShield / 2, rect.getBottom(), this.ParentConnectorShield, bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From - rect.getBottom());
                state.MergeSpacer(verticalSpacer);
                // horizontal protector
                var firstInRow = bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState();
                var horizontalSpacer = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings + 1) | 0, OrgChart.Layout.BoxTree.Node);
                OrgChart.Layout.LayoutAlgorithm.AdjustSpacer(horizontalSpacer.getState(), firstInRow.getLeft(), firstInRow.SiblingsRowV.From - this.ParentChildSpacing, bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings - 1) | 0, OrgChart.Layout.BoxTree.Node)
                    .getState()
                    .getRight() - firstInRow.getLeft(), this.ParentChildSpacing);
        ...
        RouteConnectors: function (state, node) {
            ...
            if (node.getChildren() == null) {
                throw new bridge_1.System.Exception("State is present, but children not set");
            }
            if (count === 1) {
                segments[0] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(center, rootRect.getBottom()), new OrgChart.Layout.Point.$ctor1(center, bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node)
                    .getState()
                    .getTop()));
            }
            else {
                var space = bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From - rootRect.getBottom();
                ...
                for (var i = 0; i < normalChildCount; i = (i + 1) | 0) {
                    var childRect = bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node).getState();
                ...
                segments[(count - 1) | 0] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(segments[1].To.X, segments[1].To.Y), new OrgChart.Layout.Point.$ctor1(segments[(count - 2) | 0].To.X, segments[1].To.Y));
            }
            node.getState().Connector = new OrgChart.Layout.Connector(segments);
        },
    });
     ...
     * @augments OrgChart.Layout.LayoutStrategyBase
     */
    bridge_1.Bridge.define("OrgChart.Layout.MultiLineFishboneLayoutStrategy.SingleFishboneLayoutAdapter", {
        inherits: [OrgChart.Layout.LayoutStrategyBase],
        RealRoot: null,
        SpecialRoot: null,
        Iterator: null,
        ctor: function (realRoot) {
            ...
            this.Iterator = new OrgChart.Layout.MultiLineFishboneLayoutStrategy.SingleFishboneLayoutAdapter.GroupIterator(realRoot.getState().NumberOfSiblings, realRoot.getState().NumberOfSiblingColumns);
            this.RealRoot = realRoot;
            this.SpecialRoot = bridge_1.Bridge.merge(new OrgChart.Layout.MultiLineFishboneLayoutStrategy.SingleFishboneLayoutAdapter.TreeNodeView(OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, realRoot.getElement().Id, true)), {
                setLevel: this.RealRoot.getLevel(),
                setParentNode: this.RealRoot,
            });
            this.SpecialRoot.getState().setEffectiveLayoutStrategy(this);
            var parentStrategy = bridge_1.Bridge.cast(realRoot.getState().RequireLayoutStrategy(), OrgChart.Layout.MultiLineFishboneLayoutStrategy);
        ...
        NextGroup: function () {
            ...
            for (var i = 0; i < this.Iterator.Count; i = (i + 1) | 0) {
                this.SpecialRoot.AddChildView(bridge_1.System.Array.getItem(this.RealRoot.getChildren(), (this.Iterator.FromIndex + i) | 0, OrgChart.Layout.BoxTree.Node));
            }
            var spacer = bridge_1.System.Array.getItem(this.RealRoot.getChildren(), (((this.RealRoot.getState().NumberOfSiblings + 1) | 0) +
                this.Iterator.Group) |
                0, OrgChart.Layout.BoxTree.Node);
        ...
        PreProcessThisNode: function (state, node) {
            throw new bridge_1.System.NotSupportedException();
        },
        ApplyVerticalLayout: function (state, level) {
            var $t, $t1;
            var prevRowBottom = ($t = this.RealRoot.getAssistantsRoot()) != null
            ...
            for (var i = 0; i < this.Iterator.MaxOnLeft; i = (i + 1) | 0) {
                var spacing = i === 0 ? this.ParentChildSpacing : this.SiblingSpacing;
                var child = bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), i, OrgChart.Layout.BoxTree.Node);
                var frame = child.getState();
                OrgChart.Layout.LayoutAlgorithm.MoveTo(frame, frame.getLeft(), prevRowBottom + spacing);
                var rowExterior = new OrgChart.Layout.Dimensions.$ctor1(frame.getTop(), frame.getBottom());
                var i2 = (i + this.Iterator.MaxOnLeft) | 0;
                if (i2 < this.Iterator.Count) {
                    var child2 = bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), i2, OrgChart.Layout.BoxTree.Node);
                    var frame2 = child2.getState();
                    OrgChart.Layout.LayoutAlgorithm.MoveTo(frame2, frame2.getLeft(), prevRowBottom + spacing);
                    if (frame2.getBottom() > frame.getBottom()) {
                        OrgChart.Layout.LayoutAlgorithm.MoveTo(frame, frame.getLeft(), frame2.getCenterV() - frame.Size.Height / 2);
        ...
        ApplyHorizontalLayout: function (state, level) {
            if (!bridge_1.Bridge.referenceEquals(level.BranchRoot, this.SpecialRoot)) {
                throw new bridge_1.System.InvalidOperationException("Wrong root node received");
            }
            var left = true;
            var countOnThisSide = 0;
            for (var i = 0; i < this.Iterator.Count; i = (i + 1) | 0) {
                ...
                // then add a carrier protector
                // then top-bottom to fill right side of the group
                if ((countOnThisSide = (countOnThisSide + 1) | 0) ===
                    this.Iterator.MaxOnLeft) {
                    if (left) {
                        // horizontally align children in left pillar
                        OrgChart.Layout.LayoutAlgorithm.AlignHorizontalCenters(state, level, this.EnumerateSiblings(0, this.Iterator.MaxOnLeft));
                        left = false;
                        countOnThisSide = 0;
                        var rightmost = bridge_1.System.Double.min;
                        for (var k = 0; k < i; k = (k + 1) | 0) {
                            rightmost = Math.max(rightmost, bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), k, OrgChart.Layout.BoxTree.Node)
                                .getState()
                                .BranchExterior.getRight());
                        }
                        rightmost = Math.max(rightmost, child.getState().getRight());
                        // integrate protector for group's vertical carrier
                        var spacer = bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), this.SpecialRoot.getState().NumberOfSiblings, OrgChart.Layout.BoxTree.Node);
                        OrgChart.Layout.LayoutAlgorithm.AdjustSpacer(spacer.getState(), rightmost, bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From, this.SiblingSpacing, child.getState().SiblingsRowV.To -
                            bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From);
                        level.Boundary.MergeFrom$1(spacer);
                    }
                }
            }
            // horizontally align children in right pillar
            OrgChart.Layout.LayoutAlgorithm.AlignHorizontalCenters(state, level, this.EnumerateSiblings(this.Iterator.MaxOnLeft, this.Iterator.Count));
        },
        EnumerateSiblings: function (from, to) {
            var $yield = [];
            for (var i = from; i < to; i = (i + 1) | 0) {
                $yield.push(bridge_1.System.Array.getItem(this.SpecialRoot.getChildren(), i, OrgChart.Layout.BoxTree.Node));
            }
            return bridge_1.System.Array.toEnumerable($yield);
        },
        RouteConnectors: function (state, node) {
    ...
    bridge_1.Bridge.define("OrgChart.Layout.MultiLineFishboneLayoutStrategy.SingleFishboneLayoutAdapter.TreeNodeView", {
        ...
        Prepare: function (capacity) {
            if (this.getChildren() == null) {
                this.setChildren(new (bridge_1.System.Collections.Generic.List$1(OrgChart.Layout.BoxTree.Node))(capacity));
            }
            else {
                bridge_1.System.Array.clear(this.getChildren(), OrgChart.Layout.BoxTree.Node);
            }
        },
        AddChildView: function (node) {
            bridge_1.System.Array.add(this.getChildren(), node, OrgChart.Layout.BoxTree.Node);
        },
    });
    /**
     ...
     * @augments OrgChart.Layout.LayoutStrategyBase
     */
    bridge_1.Bridge.define("OrgChart.Layout.SingleColumnLayoutStrategy", {
        inherits: [OrgChart.Layout.LayoutStrategyBase],
        /**
           * <pre><code>true</code></pre> if this strategy supports special layout for assistant boxes.
           If not, assistants will be processed as part of normal children group.
         ...
         */
        PreProcessThisNode: function (state, node) {
            if (this.ParentAlignment !== OrgChart.Layout.BranchParentAlignment.Left &&
                this.ParentAlignment !== OrgChart.Layout.BranchParentAlignment.Right) {
                throw new bridge_1.System.InvalidOperationException("Unsupported value for ParentAlignment");
            }
            node.getState().NumberOfSiblings = node.getElement().IsCollapsed
                ? 0
                : node.getChildCount();
        ...
        ApplyVerticalLayout: function (state, level) {
            ...
            var prevRowExterior = new OrgChart.Layout.Dimensions.$ctor1(node.getState().SiblingsRowV.From, node.getAssistantsRoot() == null
                ? node.getState().SiblingsRowV.To
                : node.getState().BranchExterior.getBottom());
            for (var row = 0; row < node.getState().NumberOfSiblings; row = (row + 1) | 0) {
                // first, compute
                var child = bridge_1.System.Array.getItem(node.getChildren(), row, OrgChart.Layout.BoxTree.Node);
                var rect = child.getState();
                var top = prevRowExterior.To +
                ...
                child = bridge_1.System.Array.getItem(node.getChildren(), row, OrgChart.Layout.BoxTree.Node);
        ...
        ApplyHorizontalLayout: function (state, level) {
            ...
            var edges = OrgChart.Layout.LayoutAlgorithm.AlignHorizontalCenters(state, level, this.EnumerateColumn(node));
            if (node.getLevel() > 0 && node.getChildCount() > 0) {
                var rect = node.getState();
                var diff;
                if (this.ParentAlignment === OrgChart.Layout.BranchParentAlignment.Left) {
                    ...
                    throw new bridge_1.System.InvalidOperationException("Invalid ParentAlignment setting");
                }
                // vertical connector from parent
                OrgChart.Layout.LayoutAlgorithm.MoveChildrenOnly(state, level, diff);
                // spacer for the vertical carrier
                var verticalSpacer = node.getLevel() > 0
                    ? bridge_1.System.Array.getItem(node.getChildren(), (node.getChildCount() - 1) | 0, OrgChart.Layout.BoxTree.Node)
                    : null;
                if (verticalSpacer != null) {
                    var spacerTop = node.getState().getBottom();
                    var spacerBottom = bridge_1.System.Array.getItem(node.getChildren(), (node.getChildCount() - 2) | 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getBottom();
        ...
        EnumerateColumn: function (branchRoot) {
            ...
            for (var i = 0; i < branchRoot.getState().NumberOfSiblings; i = (i + 1) | 0) {
                $yield.push(bridge_1.System.Array.getItem(branchRoot.getChildren(), i, OrgChart.Layout.BoxTree.Node));
            }
            return bridge_1.System.Array.toEnumerable($yield);
        },
        /**
        ...
        RouteConnectors: function (state, node) {
            ...
            var rootRect = node.getState();
            var center = rootRect.getCenterH();
            var verticalCarrierHeight = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings - 1) | 0, OrgChart.Layout.BoxTree.Node)
                .getState()
            ...
            for (var ix = 0; ix < node.getState().NumberOfSiblings; ix = (ix + 1) | 0) {
                var rect = bridge_1.System.Array.getItem(node.getChildren(), ix, OrgChart.Layout.BoxTree.Node).getState();
                var destination = this.ParentAlignment === OrgChart.Layout.BranchParentAlignment.Left
                    ? rect.getLeft()
                    : rect.getRight();
     ...
     * @augments OrgChart.Layout.LayoutStrategyBase
     */
    bridge_1.Bridge.define("OrgChart.Layout.StackingLayoutStrategy", {
        inherits: [OrgChart.Layout.LayoutStrategyBase],
        /**
        ...
        PreProcessThisNode: function (state, node) {
            ...
            if (node.getState().NumberOfSiblings > 0) {
                ...
                if (this.Orientation !==
                    ...
                    throw new bridge_1.System.InvalidOperationException("Unsupported value for orientation: " +
                        bridge_1.System.Enum.toString(OrgChart.Layout.StackOrientation, this.Orientation));
                }
            }
        },
        /**
        ...
        ApplyVerticalLayout: function (state, level) {
            ...
            if (this.Orientation ===
                ...
                for (var row = 0; row < node.getState().NumberOfSiblings; row = (row + 1) | 0) {
                    // first, compute
                    var child2 = bridge_1.System.Array.getItem(node.getChildren(), row, OrgChart.Layout.BoxTree.Node);
                    var rect1 = child2.getState();
                    var top1 = prevRowExterior.To +
                        (row === 0 ? this.ParentChildSpacing : this.SiblingSpacing);
                    ...
                    child2 = bridge_1.System.Array.getItem(node.getChildren(), row, OrgChart.Layout.BoxTree.Node);
        ...
        ApplyHorizontalLayout: function (state, level) {
            var $t;
            var node = level.BranchRoot;
            $t = bridge_1.Bridge.getEnumerator(node.getChildren(), OrgChart.Layout.BoxTree.Node);
            while ($t.moveNext()) {
                var child = $t.getCurrent();
                // re-enter layout algorithm for child branch
                OrgChart.Layout.LayoutAlgorithm.HorizontalLayout(state, child);
            ...
            if (node.getChildCount() > 0) {
                if (this.Orientation ===
                    ...
                    var width = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings - 1) | 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getRight() -
                        bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node)
                            .getState()
                            .getLeft();
                    ...
                    var center = (bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getLeft() +
                        bridge_1.System.Array.getItem(node.getChildren(), (node.getChildCount() - 1) | 0, OrgChart.Layout.BoxTree.Node)
                            .getState()
                    ...
                    // now position children under the parent
                    var center1 = bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getCenterH();
     ...
     */
    bridge_1.Bridge.define("OrgChart.Test.TestDataItem", {
     ...
     */
    bridge_1.Bridge.define("OrgChart.Test.TestDataSource", {
        ...
        config: {
            ...
            init: function () {
                this.Items = new (bridge_1.System.Collections.Generic.Dictionary$2(String, OrgChart.Test.TestDataItem))();
            },
        },
        /**
        ...
        getAllDataItemIds: function () {
            return bridge_1.System.Linq.Enumerable.from(this.Items.getKeys()).orderBy($asm.$.OrgChart.Test.TestDataSource.f1);
        },
        /**
        ...
        getGetParentKeyFunc: function () {
            return bridge_1.Bridge.fn.bind(this, this.GetParentKey);
        },
        /**
        ...
        getGetDataItemFunc: function () {
            return bridge_1.Bridge.fn.bind(this, this.GetDataItem);
        },
        /**
    ...
    bridge_1.Bridge.ns("OrgChart.Test.TestDataSource", $asm.$);
    bridge_1.Bridge.apply($asm.$.OrgChart.Test.TestDataSource, {
        f1: function (x) {
            return x;
        },
    });
     ...
     */
    bridge_1.Bridge.define("OrgChart.Layout.MultiLineFishboneLayoutStrategy", {
        ...
        PreProcessThisNode: function (state, node) {
            if (this.MaxGroups <= 0) {
                throw new bridge_1.System.InvalidOperationException("MaxGroups must be a positive value");
            }
            ...
            if (node.getState().NumberOfSiblings > 0) {
                ...
                node.getState().NumberOfSiblingRows =
                    bridge_1.Bridge.Int.div(node.getState().NumberOfSiblings, (this.MaxGroups * 2) | 0) | 0;
                ...
                var parentSpacer = OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, node.getElement().Id, false);
        ...
        ApplyVerticalLayout: function (state, level) {
            ...
            var adapter = new OrgChart.Layout.MultiLineFishboneLayoutStrategy.SingleFishboneLayoutAdapter(node);
        ...
        ApplyHorizontalLayout: function (state, level) {
            ...
            if (node.getLevel() > 0) {
                var diff;
                if (node.getState().NumberOfSiblingColumns > 1) {
                    var leftCarrier = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings + 1) | 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getCenterH();
                    var rightCarrier = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings +
                    ...
                    var carrier = bridge_1.System.Array.getItem(node.getChildren(), (1 + node.getState().NumberOfSiblings) | 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getCenterH();
            ...
            if (node.getLevel() > 0) {
                ...
                var verticalSpacer = bridge_1.System.Array.getItem(node.getChildren(), ix, OrgChart.Layout.BoxTree.Node);
                OrgChart.Layout.LayoutAlgorithm.AdjustSpacer(verticalSpacer.getState(), rect.getCenterH() - this.ParentConnectorShield / 2, rect.getBottom(), this.ParentConnectorShield, bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From - rect.getBottom());
                state.MergeSpacer(verticalSpacer);
                ix = (ix + 1) | 0;
                ...
                if (node.getState().NumberOfSiblingColumns > 1) {
                    ...
                    var horizontalSpacer = bridge_1.System.Array.getItem(node.getChildren(), ix, OrgChart.Layout.BoxTree.Node);
                    var leftmost = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings + 1) | 0, OrgChart.Layout.BoxTree.Node).getState().TopLeft;
                    var rightmost = bridge_1.System.Array.getItem(node.getChildren(), (ix - 1) | 0, OrgChart.Layout.BoxTree.Node)
                        .getState()
                        .getRight();
        ...
        RouteConnectors: function (state, node) {
            ...
            // parent connector
            var space = bridge_1.System.Array.getItem(node.getChildren(), 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From - rootRect.getBottom();
            segments[bridge_1.Bridge.identity(ix, (ix = (ix + 1) | 0))] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(center, rootRect.getBottom()), new OrgChart.Layout.Point.$ctor1(center, rootRect.getBottom() + space - this.ChildConnectorHookLength));
            // one hook for each child
            ...
            while (iterator.NextGroup()) {
                var carrier = bridge_1.System.Array.getItem(node.getChildren(), (((1 + node.getState().NumberOfSiblings) | 0) + iterator.Group) | 0, OrgChart.Layout.BoxTree.Node).getState();
                var from = carrier.getCenterH();
                var isLeft = true;
                var countOnThisSide = 0;
                for (var i = iterator.FromIndex; i < ((iterator.FromIndex + iterator.Count) | 0); i = (i + 1) | 0) {
                    ...
                    if ((countOnThisSide = (countOnThisSide + 1) | 0) === iterator.MaxOnLeft) {
                        ...
                        if (isLeft) {
                            // one for each vertical carrier
                            segments[(((1 + node.getState().NumberOfSiblings) | 0) +
                                iterator.Group) |
                                0] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(carrier.getCenterH(), carrier.getTop() - this.ChildConnectorHookLength), new OrgChart.Layout.Point.$ctor1(carrier.getCenterH(), bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node)
                                .getState()
                                .getCenterV()));
                        }
                        isLeft = !isLeft;
            ...
            ix = (ix + node.getState().NumberOfSiblingColumns) | 0;
            if (node.getState().NumberOfSiblingColumns > 1) {
                var leftGroup = bridge_1.System.Array.getItem(node.getChildren(), (1 + node.getState().NumberOfSiblings) | 0, OrgChart.Layout.BoxTree.Node).getState();
                var rightGroup = bridge_1.System.Array.getItem(node.getChildren(), (((((1 + node.getState().NumberOfSiblings) | 0) +
                    node.getState().NumberOfSiblingColumns) |
                    0) -
                    1) |
                    0, OrgChart.Layout.BoxTree.Node).getState();
     ...
     * @augments OrgChart.Layout.LinearLayoutStrategy
     */
    bridge_1.Bridge.define("OrgChart.Layout.MultiLineHangerLayoutStrategy", {
        inherits: [OrgChart.Layout.LinearLayoutStrategy],
        /**
        ...
        PreProcessThisNode: function (state, node) {
            if (this.MaxSiblingsPerRow <= 0 || this.MaxSiblingsPerRow % 2 !== 0) {
                throw new bridge_1.System.InvalidOperationException("MaxSiblingsPerRow must be a positive even value");
            }
            ...
            if (node.getState().NumberOfSiblings > 0) {
                ...
                node.getState().NumberOfSiblingRows =
                    bridge_1.Bridge.Int.div(node.getChildCount(), this.MaxSiblingsPerRow) | 0;
                ...
                if (lastRowBoxCount > 0 &&
                    lastRowBoxCount <= (bridge_1.Bridge.Int.div(this.MaxSiblingsPerRow, 2) | 0)) {
                ...
                var ix = bridge_1.Bridge.Int.div(this.MaxSiblingsPerRow, 2) | 0;
                while (ix < node.getState().NumberOfSiblings) {
                    var siblingSpacer = OrgChart.Layout.Box.Special(OrgChart.Layout.Box.None, node.getElement().Id, false);
        ...
        ApplyVerticalLayout: function (state, level) {
            ...
            for (var row = 0; row < node.getState().NumberOfSiblingRows; row = (row + 1) | 0) {
                ...
                siblingsRowExterior = new OrgChart.Layout.Dimensions.$ctor1(siblingsRowExterior.From, siblingsRowExterior.To);
                var siblingsBottom = bridge_1.System.Double.min;
                ...
                prevRowExterior = new OrgChart.Layout.Dimensions.$ctor1(siblingsRowExterior.From, Math.max(siblingsBottom, siblingsRowExterior.To));
                // now assign size to the vertical spacer, if any
                var spacerIndex = (from +
                    (bridge_1.Bridge.Int.div(node.getState().NumberOfSiblingColumns, 2) | 0)) |
                    0;
                if (spacerIndex < node.getState().NumberOfSiblings) {
                    ...
                    var spacerBottom = row === ((node.getState().NumberOfSiblingRows - 1) | 0)
                        ? bridge_1.System.Array.getItem(node.getChildren(), (spacerIndex - 1) | 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.To
                        : prevRowExterior.To;
                    var spacer = bridge_1.System.Array.getItem(node.getChildren(), spacerIndex, OrgChart.Layout.BoxTree.Node).getState();
        ...
        ApplyHorizontalLayout: function (state, level) {
            ...
            for (var col = 0; col < node.getState().NumberOfSiblingColumns; col = (col + 1) | 0) {
                ...
                for (var row = 0; row < node.getState().NumberOfSiblingRows; row = (row + 1) | 0) {
                    ...
                    var child = bridge_1.System.Array.getItem(node.getChildren(), ix, OrgChart.Layout.BoxTree.Node);
                    // re-enter layout algorithm for child branch
                    OrgChart.Layout.LayoutAlgorithm.HorizontalLayout(state, child);
                }
            ...
            var rect = node.getState();
            var spacer = bridge_1.System.Array.getItem(node.getChildren(), bridge_1.Bridge.Int.div(node.getState().NumberOfSiblingColumns, 2) | 0, OrgChart.Layout.BoxTree.Node);
            ...
            for (var firstInRowIndex = 0; firstInRowIndex < node.getState().NumberOfSiblings; firstInRowIndex =
                (firstInRowIndex + node.getState().NumberOfSiblingColumns) | 0) {
                var firstInRow = bridge_1.System.Array.getItem(node.getChildren(), firstInRowIndex, OrgChart.Layout.BoxTree.Node).getState();
                var lastInRow = bridge_1.System.Array.getItem(node.getChildren(), Math.min((((firstInRowIndex + node.getState().NumberOfSiblingColumns) | 0) -
                    1) |
                    0, (node.getState().NumberOfSiblings - 1) | 0), OrgChart.Layout.BoxTree.Node).getState();
                var horizontalSpacer = bridge_1.System.Array.getItem(node.getChildren(), (((1 + node.getState().NumberOfSiblings) | 0) +
                    (bridge_1.Bridge.Int.div(firstInRowIndex, node.getState().NumberOfSiblingColumns) |
                        0)) |
                    0, OrgChart.Layout.BoxTree.Node);
                var width = lastInRow.getRight() >= verticalSpacer.getState().getRight()
        ...
        EnumerateColumn: function (branchRoot, col) {
            ...
            for (var row = 0; row < branchRoot.getState().NumberOfSiblingRows; row = (row + 1) | 0) {
                var ix = (((row * branchRoot.getState().NumberOfSiblingColumns) | 0) + col) |
                    0;
                if (ix >= branchRoot.getState().NumberOfSiblings) {
                    break;
                }
                $yield.push(bridge_1.System.Array.getItem(branchRoot.getChildren(), ix, OrgChart.Layout.BoxTree.Node));
            }
            return bridge_1.System.Array.toEnumerable($yield);
        },
        /**
        ...
        RouteConnectors: function (state, node) {
            ...
            var rootRect = node.getState();
            var center = rootRect.getCenterH();
            var verticalCarrierHeight = bridge_1.System.Array.getItem(node.getChildren(), (node.getState().NumberOfSiblings - 1) | 0, OrgChart.Layout.BoxTree.Node).getState().SiblingsRowV.From -
            ...
            var ix = 1;
            for (var i = 0; i < node.getState().NumberOfSiblings; i = (i + 1) | 0) {
                var child1 = bridge_1.System.Array.getItem(node.getChildren(), i, OrgChart.Layout.BoxTree.Node);
                if (!child1.getElement().IsSpecial) {
                    var childRect = child1.getState();
                    var childCenter = childRect.getCenterH();
                    segments[bridge_1.Bridge.identity(ix, (ix = (ix + 1) | 0))] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(childCenter, childRect.getTop()), new OrgChart.Layout.Point.$ctor1(childCenter, childRect.getTop() - this.ChildConnectorHookLength));
                }
            }
            ...
            for (var firstInRowIndex = 1; firstInRowIndex < ((count - node.getState().NumberOfSiblingRows) | 0); firstInRowIndex = (firstInRowIndex + this.MaxSiblingsPerRow) | 0) {
                ...
                if (lastInRow.From.X < segments[0].From.X) {
                    segments[bridge_1.Bridge.identity(ix, (ix = (ix + 1) | 0))] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(firstInRow.To.X, firstInRow.To.Y), new OrgChart.Layout.Point.$ctor1(segments[0].To.X, firstInRow.To.Y));
                }
                else {
                    segments[bridge_1.Bridge.identity(ix, (ix = (ix + 1) | 0))] = new OrgChart.Layout.Edge.$ctor1(new OrgChart.Layout.Point.$ctor1(firstInRow.To.X, firstInRow.To.Y), new OrgChart.Layout.Point.$ctor1(lastInRow.To.X, firstInRow.To.Y));
                }
            }
            node.getState().Connector = new OrgChart.Layout.Connector(segments);
        },
    });
    var $m = bridge_1.Bridge.setMetadata, $n = [
        OrgChart.Layout,
        bridge_1.System,
        bridge_1.System.Collections.Generic,
    ...
    $m($n[0].Boundary.Step, function () {
        return {
            at: [
                new bridge_1.System.Diagnostics.DebuggerDisplayAttribute("{X}, {Top} - {Bottom}, {Node.Element.Id}"),
            ],
            m: [
                {
                    at: [new OrgChart.Annotations.NotNullAttribute()],
    ...
    $m($n[0].Box, function () {
        return {
            at: [
                new bridge_1.System.Diagnostics.DebuggerDisplayAttribute("{Id}, Size.Width}x{Size.Height}"),
            ],
            m: [
                {
                    at: [new OrgChart.Annotations.NotNullAttribute()],
    ...
    $m($n[0].Frame1, function () {
        return {
            at: [
                new bridge_1.System.Diagnostics.DebuggerDisplayAttribute("{Exterior.Left}:{Exterior.Top}, {Exterior.Size.Width}x{Exterior.Size.Height}"),
            ],
            m: [
                {
                    at: [new OrgChart.Annotations.CanBeNullAttribute()],
    ...
    $m($n[0].LayoutState.LayoutLevel, function () {
        return {
            at: [
                new bridge_1.System.Diagnostics.DebuggerDisplayAttribute("{BranchRoot.Element.Id}, {Boundary.BoundingRect.Top}..{Boundary.BoundingRect.Bottom}"),
            ],
        };
    });
    ...
    $m($n[0].Rect, function () {
        return {
            at: [
                new bridge_1.System.Diagnostics.DebuggerDisplayAttribute("{TopLeft.X}:{TopLeft.Y}, {Size.Width}x{Size.Height}"),
            ],
        };
    });
